...
/// a general conversion back-and-force is needed, consider the `diem_std::Any` type which preserves invariants.
///
/// Example:
/// ```
/// use std::bcs;
