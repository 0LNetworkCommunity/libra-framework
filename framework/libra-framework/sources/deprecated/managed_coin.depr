...
module diem_framework::managed_coin {
    use std::string;
    use std::error;
    use std::signer;

    use diem_framework::coin::{Self, BurnCapability, FreezeCapability, MintCapability};
    ...
    public entry fun test_end_to_end(
        ...
        diem_framework::account::create_account_for_test(source_addr);
        diem_framework::account::create_account_for_test(destination_addr);
        diem_framework::account::create_account_for_test(signer::address_of(&mod_account));
    ...
    public entry fun fail_mint(
        ...
        diem_framework::account::create_account_for_test(source_addr);
        diem_framework::account::create_account_for_test(signer::address_of(&destination));
        diem_framework::account::create_account_for_test(signer::address_of(&mod_account));
        aggregator_factory::initialize_aggregator_factory_for_test(&mod_account);
