spec diem_framework::vesting {
    ...
    spec set_beneficiary(
        ...
        aborts_if !coin::is_account_registered<DiemCoin>(new_beneficiary);
        include VerifyAdminAbortsIf;
    ...
    spec withdraw_stake(vesting_contract: &VestingContract, contract_address: address): Coin<DiemCoin> {
        // TODO: Calls `staking_contract::distribute` which is not verified.
        pragma verify = false;
    }
