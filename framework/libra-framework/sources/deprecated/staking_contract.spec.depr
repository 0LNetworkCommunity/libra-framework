spec diem_framework::staking_contract {
    spec module {
        pragma verify = true;
    ...
    spec create_staking_contract(
        ...
        include WithdrawAbortsIf<DiemCoin> {account: staker};
    }
    ...
    spec add_stake(staker: &signer, operator: address, amount: u64) {
        ...
        let staked_coins = coin::Coin<DiemCoin>{ value: amount };
    ...
    spec schema IncreaseLockupWithCapAbortsIf{
        ...
        let seconds =  global<timestamp::CurrentTimeMicroseconds>(@diem_framework).microseconds / timestamp::MICRO_CONVERSION_FACTOR;
