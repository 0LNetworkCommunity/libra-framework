...
module ol_framework::test_multi_action {
    ...
    fun migrate_offer_account_initialized(root: &signer, alice: &signer) {
        ...
        // migrate the offer
        multi_action::migrate_offer(alice, alice_address);
    ...
    fun migrate_offer_account_finalized(root: &signer, alice: &signer, bob: &signer, carol: &signer, dave: &signer) {
        ...
        multi_action::migrate_offer(carol, alice_address);
        assert!(multi_action::exists_offer(alice_address) == true, 7357002);
    ...
    #[test(root = @ol_framework, alice = @0x1000a)]
    #[expected_failure(abort_code = 0x80025, location = ol_framework::multi_action)]
    ...
    #[test(root = @ol_framework, alice = @0x1000a, bob = @0x1000b)]
    #[expected_failure(abort_code = 0x50003, location = ol_framework::multi_action)]
    fun migrate_offer_without_authority(root: &signer, alice: &signer, bob: &signer) {
        ...
        // try to migrate offer
        multi_action::migrate_offer(bob, alice_address);
    }
