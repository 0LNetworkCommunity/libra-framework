...
<pre><code><b>public</b> entry <b>fun</b> <a href="resource_account.md#0x1_resource_account_create_resource_account">create_resource_account</a>(origin: &<a href="">signer</a>, seed: <a href="">vector</a>&lt;u8&gt;, optional_auth_key: <a href="">vector</a>&lt;u8&gt;)
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="resource_account.md#0x1_resource_account_create_resource_account_and_fund">create_resource_account_and_fund</a>(origin: &<a href="">signer</a>, seed: <a href="">vector</a>&lt;u8&gt;, optional_auth_key: <a href="">vector</a>&lt;u8&gt;, fund_amount: u64)
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="resource_account.md#0x1_resource_account_create_resource_account_and_publish_package">create_resource_account_and_publish_package</a>(origin: &<a href="">signer</a>, seed: <a href="">vector</a>&lt;u8&gt;, metadata_serialized: <a href="">vector</a>&lt;u8&gt;, <a href="code.md#0x1_code">code</a>: <a href="">vector</a>&lt;<a href="">vector</a>&lt;u8&gt;&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="resource_account.md#0x1_resource_account_retrieve_resource_account_cap">retrieve_resource_account_cap</a>(
    ...
    <b>let</b> (resource_signer_cap, empty_container) = {
        ...
        <b>assert</b>!(<a href="_contains_key">simple_map::contains_key</a>(&container.store, &resource_addr), <a href="_invalid_argument">error::invalid_argument</a>(<a href="resource_account.md#0x1_resource_account_EUNAUTHORIZED_NOT_OWNER">EUNAUTHORIZED_NOT_OWNER</a>));
...
<pre><code><b>let</b> resource_addr = <a href="_address_of">signer::address_of</a>(resource);
...
<pre><code><b>schema</b> <a href="resource_account.md#0x1_resource_account_RotateAccountAuthenticationKeyAndStoreCapabilityAbortsIf">RotateAccountAuthenticationKeyAndStoreCapabilityAbortsIf</a> {
    ...
    <b>aborts_if</b> <b>exists</b>&lt;<a href="resource_account.md#0x1_resource_account_Container">Container</a>&gt;(origin_addr) && <a href="_spec_contains_key">simple_map::spec_contains_key</a>(container.store, resource_addr);
...
<b>let</b> resource_addr = <a href="_address_of">signer::address_of</a>(resource);
<b>let</b> container = <b>borrow_global_mut</b>&lt;<a href="resource_account.md#0x1_resource_account_Container">Container</a>&gt;(source_addr);
<b>aborts_if</b> !<a href="_spec_contains_key">simple_map::spec_contains_key</a>(container.store, resource_addr);
