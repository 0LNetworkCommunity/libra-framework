...
// pub fn commit_proof_tx(tx_params: &TxParams, block: VDFProof) -> Result<TransactionOnchainData, TxError> {
...
pub fn commit_proof_tx(block: VDFProof) -> anyhow::Result<TransactionOnchainData> {
